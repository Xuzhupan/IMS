...
<body>
	<form id="updatePwd">
		...
		<table>
			<tr>
				<td class="tdTitle"><label>旧密码:</label></td>
				<td><input class="easyui-validatebox"  name="password" required="true" type="password"></td>
			</tr>
			<tr>
				<td class="tdTitle"><label>新密码:</label></td>
				<td><input class="easyui-validatebox" id="password" name="passwordNew" required="true" type="password"></td>
			</tr>
			<tr>
